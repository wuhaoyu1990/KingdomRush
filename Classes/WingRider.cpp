...
WingRider* WingRider::createMonster(std::vector<Point> points)
{
...
bool WingRider::init()
{
	...
	setMonsterType(WINGRIDER);
	setName("WingRider_");
	baseSprite = Sprite::createWithSpriteFrameName("CanibalWingRider_0001.png");
	addChild(baseSprite);
	createAndSetHpBar();
